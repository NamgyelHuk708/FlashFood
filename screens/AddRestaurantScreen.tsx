...
export default function AddRestaurantScreen({ navigation }: any) {
  ...
  async function submitRestaurant() {
    ...
    try {
        ...
        .insert([
          {
            ...
            owner_verified: true, // Changed from false to true
            // Default coordinates (you might want to add geocoding here)
            latitude: 40.7128,
            longitude: -74.006,
            rating: 0,
          },
      ...
      const { error: ownershipError } = await supabase.from("restaurant_owners").insert([
        {
          user_id: user.id,
          restaurant_id: restaurant.id,
          role: "owner",
          status: "approved", // Auto-approve for now, you might want a review process
        },
      ])

      if (ownershipError) throw ownershipError

      Alert.alert("Success", "Restaurant added successfully and is now live!", [
        {
          text: "OK",
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            Your restaurant will be added immediately and will appear in search results right away.
          </Text>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
